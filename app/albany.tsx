...
export default function Page() {
    ...
    const albanyEvents = events
        .map((event, index) => ({ ...event, originalIndex: index }))
        .filter(event => event.eventcity === "Albany" && event.eventstate === "NY");
  ...
  return(
    <View style={styles.container}>
      <View style={styles.imageContainer}>
        ...
        />
        {/* Overlay Images for albany Events */}
        {albanyEvents.map((event) => {
        ...
        <TouchableOpacity style={styles.navigationButton} onPress={() => router.push('/albanyEvents')}>
            <Text style={styles.buttonText}>Albany Events</Text>
        </TouchableOpacity>
      </View>
    </View>
  )
